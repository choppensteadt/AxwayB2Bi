 ...
 * to send analytic data that can be viewed on the AxwayB2BCommunityManagement Dashboard.
 *
 * For information on getting started with AxwayB2BCommunityManagement Platform Services,
