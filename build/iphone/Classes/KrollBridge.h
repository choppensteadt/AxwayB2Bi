...
@interface AxwayB2BCommunityManagementObject : KrollCoverageObject {
#else
@interface AxwayB2BCommunityManagementObject : KrollObject {
#endif
@private
...
extern NSString * AxwayB2BCommunityManagement$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	AxwayB2BCommunityManagementObject *_axwayb2bcommunitymanagement;
    KrollObject* console;
	BOOL shutdown;
