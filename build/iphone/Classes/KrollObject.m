...
//@interface AxwayB2BCommunityManagementObject : NSObject
//@end

@interface AxwayB2BCommunityManagementObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[AxwayB2BCommunityManagementObject class]])
		{
			for (NSString *key in [[(AxwayB2BCommunityManagementObject*)o modules] allKeys])
			{
