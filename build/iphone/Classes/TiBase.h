...
// in simulator we redefine to format for AxwayB2BCommunityManagement Developer console
...
{\
	NSString * exceptionName = [@"org.axwayb2bcommunitymanagement." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.axwayb2bcommunitymanagement";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIAxwayB2BCommunityManagementNativeItemNone = -1, 
	UIAxwayB2BCommunityManagementNativeItemSpinner = -2,
	UIAxwayB2BCommunityManagementNativeItemProgressBar = -3,
	
	UIAxwayB2BCommunityManagementNativeItemSlider = -4,
	UIAxwayB2BCommunityManagementNativeItemSwitch = -5,
	UIAxwayB2BCommunityManagementNativeItemMultiButton = -6,
	UIAxwayB2BCommunityManagementNativeItemSegmented = -7,
	
	UIAxwayB2BCommunityManagementNativeItemTextView = -8,
	UIAxwayB2BCommunityManagementNativeItemTextField = -9,
	UIAxwayB2BCommunityManagementNativeItemSearchBar = -10,
	
	UIAxwayB2BCommunityManagementNativeItemPicker = -11,
	UIAxwayB2BCommunityManagementNativeItemDatePicker = -12,
	
	UIAxwayB2BCommunityManagementNativeItemInfoLight = -13,
	UIAxwayB2BCommunityManagementNativeItemInfoDark = -14,
	
	UIAxwayB2BCommunityManagementNativeItemDisclosure = -15,
	
	UIAxwayB2BCommunityManagementNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all AxwayB2BCommunityManagement instances of
