...
/**
 The base class for all AxwayB2BCommunityManagement modules
 */
...
/**
 AxwayB2BCommunityManagement Platform calls this method on startup.
 */
-(void)startup;

/**
 AxwayB2BCommunityManagement Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 AxwayB2BCommunityManagement Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 AxwayB2BCommunityManagement Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 AxwayB2BCommunityManagement Platform calls this method on resume.
 @param sender The sender of the event.
 */
