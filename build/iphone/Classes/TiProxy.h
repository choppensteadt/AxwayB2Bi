...
//Rare exceptions to indicate a bug in the _axwayb2bcommunitymanagement code (Eg, function that a subclass should have implemented)
...
/**
 The base class for AxwayB2BCommunityManagement proxies.
 */
