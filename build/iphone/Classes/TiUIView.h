...
/**
 Base class for all AxwayB2BCommunityManagement views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the AxwayB2BCommunityManagement view hierarchy (such as wrapped iOS UIViews) was touched.
